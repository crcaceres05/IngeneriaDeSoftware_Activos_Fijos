...
$sql = "SELECT a.idActivo, a.No_Serial, a.Descripcion, a.Valor, a.valor  AS 'tasaCambio', a.FechaCompra, a.empresa
  FROM activo a 
...
if (isset($_POST['selectData'])) {
    ...
    $sql = "SELECT a.idActivo, a.No_Serial, a.Descripcion, a.Valor, a.FechaCompra, a.empresa, round((a.valor * tc.tasa),2) AS 'tasaCambio',
                    ...
                    <div class="card">
                        <div class="card-header">
                            <tr>
                                ...
                                <td>
                                    <a class="text-success" href="activocrear.php"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="text-warning"
                                                href="editar.php?idActivo=<?php echo $dato->idActivo; ?>"><i
                                                    class="bi bi-pencil-square"></i></a></td>
                                        <td><a onclick="return confirm('Estas seguro de eliminar?');"
                                                class="text-danger"
                                                href="controllers/eliminar.php?idActivo=<?php echo $dato->idActivo; ?>"><i
